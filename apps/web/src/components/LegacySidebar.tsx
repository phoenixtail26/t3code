...
import { LegacySidebarProjectExternalSessions } from "./ExternalSessionsSection";
...
import { forkThreadMenuEntry } from "../threadFork/menu";
...
const SidebarProjectItem = memo(function SidebarProjectItem(props: SidebarProjectItemProps) {
  ...
  // Fork wiring — see threadFork/menu.ts and ExternalSessionsSection.tsx.
  ...
  return (
    <>
      ...
      <LegacySidebarProjectExternalSessions project={project} expanded={projectExpanded} />
