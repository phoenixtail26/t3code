...
import { withForkThreadMenuItem } from "../threadFork/menu";
import { useForkThread } from "../threadFork/useForkThread";
import { SidebarExternalSessions } from "./ExternalSessionsSection";
        ...
        const clicked = await settlePromise(() =>
          api.contextMenu.show(
            withForkThreadMenuItem(
              ...
              canForkThread(serverConfigs, thread.environmentId, thread.modelSelection.instanceId),
            ),
            position,
          ),
        );
        ...
        <SidebarGroup className="ps-[calc(var(--sidebar-content-inset)+1px)] pe-[var(--sidebar-content-inset)] pb-1 pt-0">
          ...
          {!isSearchingThreads ? (
            ...
            >
              ...
              <SidebarExternalSessions projects={projects} scopedProjectKeys={scopedProjectKeys} />
            </TooltipProvider>
          ) : null}
          {!isSearchingThreads &&
