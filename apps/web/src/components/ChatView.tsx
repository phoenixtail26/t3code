...
export default function ChatView(props: ChatViewProps) {
  ...
  const timelineEntries = useMemo(() => {
    ...
    // Fork: forked/adopted threads render their inherited history above the
    // thread's own entries (threadFork/useInheritedTimeline.ts).
    return inheritedTimeline.length > 0
      ? [...inheritedTimeline, ...projection.entries]
      : projection.entries;
  }, [
